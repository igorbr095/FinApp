...
export default function App() {
  ...
  async function navegarMes(direcao) {
    ...
    await sSet("fin4_config", JSON.stringify(cfg2));
    try{const r=await sGet("fin4_rf_"+novoMes);setRecFixas(r?JSON.parse(r):[]);}catch(e){setRecFixas([]);}
    try{const r=await sGet("fin4_fl_"+novoMes);setRendas(r?JSON.parse(r):[]);}catch(e){setRendas([]);}
    try{const r=await sGet("fin4_fix_"+novoMes);setFixos(r?JSON.parse(r):[]);}catch(e){setFixos([]);}
  }
