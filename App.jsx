...
export default function App() {
  ...
  const saveRf  = useCallback(async(d)=>await sSet("fin4_rf_"+config.mes,JSON.stringify(d),token,userId),[config.mes,token,userId]);
  const saveFl  = useCallback(async(d)=>await sSet("fin4_fl_"+config.mes,JSON.stringify(d),token,userId),[config.mes,token,userId]);
  const savePes = useCallback(async(d)=>await sSet("fin4_pes",JSON.stringify(d),token,userId),[token,userId]);
  const saveFix = useCallback(async(d)=>await sSet("fin4_fix_"+config.mes,JSON.stringify(d),token,userId),[config.mes,token,userId]);
  const saveHist= useCallback(async(d)=>await sSet("fin4_hist",JSON.stringify(d),token,userId),[token,userId]);
